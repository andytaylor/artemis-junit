...
ARTEMIS_HOME='/home/ataylor/projects/artemis-arquillian/target/apache-artemis-2.5.0-SNAPSHOT'
ARTEMIS_INSTANCE='/home/ataylor/projects/artemis-arquillian/target/standalone'

# The logging config will need an URI
# this will be encoded in case you use spaces or special characters
# on your directory structure
ARTEMIS_INSTANCE_URI='file:/home/ataylor/projects/artemis-arquillian/target/standalone/'
...
# Java Opts
JAVA_ARGS=" -XX:+PrintClassHistogram -XX:+UseG1GC -XX:+AggressiveOpts -XX:+UseFastAccessorMethods -Xms512M -Xmx2G -Dhawtio.realm=activemq  -Dhawtio.offline="true" -Dhawtio.role=guest -Dhawtio.rolePrincipalClasses=org.apache.activemq.artemis.spi.core.security.jaas.RolePrincipal -Djolokia.policyLocation=${ARTEMIS_INSTANCE_URI}/etc/jolokia-access.xml"
